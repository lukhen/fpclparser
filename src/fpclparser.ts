...
export function getXEitherFoldable4Instance<A, B, C, D>(preds: {
...
export function getXEitherFoldable3Instance<A, B, C>(preds: {
    isA: (c: A | B | C) => c is A,
    isB: (c: A | B | C) => c is B,
    isC: (c: A | B | C) => c is C
}): {
